...
3. Siga las [instrucciones](instalacion-nodos.md) para implementar un nodo de escritor y envíenos la informacion del nodo que obtiene al final del proceso a info@lacchain.net para autorizar su nodo.
...
4. Siga las [instrucciones](instalacion-nodos.md) para implementar un nodo validador y envíenos la informacion del nodo que que obtiene al final del proceso a info@lacchain.net para autorizar su nodo.

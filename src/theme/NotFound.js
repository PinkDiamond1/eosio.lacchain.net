            ...
            <Box className="sectionHeroMobile">
              <Box className="section">
                <Box className="titleBox">
                    ...
                    <h2 style={{paddingLeft: '25px', paddingRight:'25px', fontSize:'20px'}} className="centerText">Por favor, regrese a la <a style={{color:'#1dc961'}} href="/">página de inicio</a> e inténtalo de nuevo.</h2>
                  </Box>
                  <p style={{paddingLeft: '25px', paddingRight:'25px',fontSize:'14px'}} className="centerText">Si tiene alguna duda sobre LACChain EOSIO diríjase a <a href="/docs/testnet/eosio">nuestra documentación</a>!</p>
                </Box>
              </Box>
            </Box>
        </Box>
